...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/schnell-erfassen', label: 'Schnell erfassen', icon: IconPlus, description: 'Neuen Eintrag in wenigen Schritten anlegen' },
  { path: '/intents/aufgabe-abschliessen', label: 'Aufgabe abschließen', icon: IconCircleCheck, description: 'Offene Aufgabe auswählen und abschließen' },
  // </custom:intents>
];
