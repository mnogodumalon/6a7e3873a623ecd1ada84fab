...
interface KlareErfassungViewDialogProps {
  open: boolean;
  onClose: () => void;
  record: KlareErfassung | null;
  onEdit: (record: KlareErfassung) => void;
}

export function KlareErfassungViewDialog({ open, onClose, record, onEdit }: KlareErfassungViewDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={v => !v && onClose()}>
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Klare Erfassung anzeigen</DialogTitle>
        </DialogHeader>
        ...
        <div className="space-y-4">
          ...
          <div className="pt-2 border-t border-border">
            <AttachmentsSection appId={APP_IDS.KLARE_ERFASSUNG} recordId={record.record_id} readOnly />
          </div>
        </div>
      </DialogContent>
    </Dialog>
